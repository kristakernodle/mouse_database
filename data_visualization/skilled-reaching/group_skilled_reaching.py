...
def plot_reach_score_count_heatmap():
    for group, color in {"Control": "Blues", "Knock-Out": "Reds"}.items():
        all_viable_trials = all_scored_trials[(all_scored_trials.genotype == group) &
                                              ...
                                              (all_scored_trials.reach_score != 9)]
        ...
        axis.hlines([8, 5, 4, 3, 2, 1], *axis.get_xlim(), colors='grey')
...
def plot_reach_score_percent_heatmap(df):
    ...
    df = df[["eartag", "genotype", "session_num", "1", "2", "3", "4", "5", "8", "Viable Trials"]]
    for i in df.index:
...
if __name__ == '__main__':
    ...
    # plot_success_rate("First Success")
    # plot_success_rate("Any Success")
